# ./data/ceesim/schema/pattern/modulationEntityRootR1_0/xsd.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:a4350b0d114ff7faaa29729d5e9d9f9b6b49754c
# Generated 2021-02-17 12:31:28.464103 by PyXB version 1.2.6 using Python 3.6.9.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:1cc16388-715f-11eb-b6f6-00155debab14')
...
# Atomic simple type: {http://www.amherst.com/CEESIM/XML}stModulationEntityMajorRevision
class stModulationEntityMajorRevision (pyxb.binding.datatypes.int):

    """An atomic simple type."""

    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'stModulationEntityMajorRevision')
    _XSDLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 38, 2)
    _Documentation = None
stModulationEntityMajorRevision._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=stModulationEntityMajorRevision, value=pyxb.binding.datatypes.int(1))
stModulationEntityMajorRevision._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value_datatype=stModulationEntityMajorRevision, value=pyxb.binding.datatypes.int(1))
stModulationEntityMajorRevision._InitializeFacetMap(stModulationEntityMajorRevision._CF_minInclusive,
   stModulationEntityMajorRevision._CF_maxInclusive)
Namespace.addCategoryObject('typeBinding', 'stModulationEntityMajorRevision', stModulationEntityMajorRevision)
_module_typeBindings.stModulationEntityMajorRevision = stModulationEntityMajorRevision

# Atomic simple type: {http://www.amherst.com/CEESIM/XML}stModulationEntityMinorRevision
class stModulationEntityMinorRevision (pyxb.binding.datatypes.int):

    """An atomic simple type."""

    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'stModulationEntityMinorRevision')
    _XSDLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 46, 2)
    _Documentation = None
stModulationEntityMinorRevision._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=stModulationEntityMinorRevision, value=pyxb.binding.datatypes.int(0))
stModulationEntityMinorRevision._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value_datatype=stModulationEntityMinorRevision, value=pyxb.binding.datatypes.int(0))
stModulationEntityMinorRevision._InitializeFacetMap(stModulationEntityMinorRevision._CF_minInclusive,
   stModulationEntityMinorRevision._CF_maxInclusive)
Namespace.addCategoryObject('typeBinding', 'stModulationEntityMinorRevision', stModulationEntityMinorRevision)
_module_typeBindings.stModulationEntityMinorRevision = stModulationEntityMinorRevision
...
class stIntIndexNumber (pyxb.binding.datatypes.int):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 63, 2)
    _Documentation = ''
...
stIntIndexNumber._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value_datatype=stIntIndexNumber, value=pyxb.binding.datatypes.int(4096))
...
class ctPatternPoints (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 57, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.amherst.com/CEESIM/XML}Pt uses Python identifier Pt
    __Pt = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Pt'), 'Pt', '__httpwww_amherst_comCEESIMXML_ctPatternPoints_httpwww_amherst_comCEESIMXMLPt', True, pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 59, 6), )
...
# Complex type {http://www.amherst.com/CEESIM/XML}ctModulationEntity with content type ELEMENT_ONLY
class ctModulationEntity (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.amherst.com/CEESIM/XML}ctModulationEntity with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'ctModulationEntity')
    _XSDLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 77, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.amherst.com/CEESIM/XML}Modulation uses Python identifier Modulation
    __Modulation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Modulation'), 'Modulation', '__httpwww_amherst_comCEESIMXML_ctModulationEntity_httpwww_amherst_comCEESIMXMLModulation', False, pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 79, 6), )

    
    Modulation = property(__Modulation.value, __Modulation.set, None, None)

    
    # Attribute Major uses Python identifier Major
    __Major = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Major'), 'Major', '__httpwww_amherst_comCEESIMXML_ctModulationEntity_Major', _module_typeBindings.stModulationEntityMajorRevision, required=True)
    __Major._DeclarationLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 81, 4)
    __Major._UseLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 81, 4)
    
    Major = property(__Major.value, __Major.set, None, None)

    
    # Attribute Minor uses Python identifier Minor
    __Minor = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Minor'), 'Minor', '__httpwww_amherst_comCEESIMXML_ctModulationEntity_Minor', _module_typeBindings.stModulationEntityMinorRevision, required=True)
    __Minor._DeclarationLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 82, 4)
    __Minor._UseLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 82, 4)
    
    Minor = property(__Minor.value, __Minor.set, None, None)

    
    # Attribute PerId uses Python identifier PerId
    __PerId = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'PerId'), 'PerId', '__httpwww_amherst_comCEESIMXML_ctModulationEntity_PerId', pyxb.binding.datatypes.string, unicode_default='')
    __PerId._DeclarationLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 83, 4)
    __PerId._UseLocation = pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 83, 4)
    
    PerId = property(__PerId.value, __PerId.set, None, None)

    _ElementMap.update({
        __Modulation.name() : __Modulation
    })
    _AttributeMap.update({
...
_module_typeBindings.ctModulationEntity = ctModulationEntity
Namespace.addCategoryObject('typeBinding', 'ctModulationEntity', ctModulationEntity)


ModulationEntity = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ModulationEntity'), ctModulationEntity, location=pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 75, 2))
Namespace.addCategoryObject('elementBinding', ModulationEntity.name().localName(), ModulationEntity)



ctPatternPoints._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Pt'), ctPatternPoint, scope=ctPatternPoints, location=pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 59, 6)))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=4096, metadata=pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 58, 4))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(ctPatternPoints._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Pt')), pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 59, 6))
...
ctModulationEntity._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Modulation'), ctPatternData, scope=ctModulationEntity, location=pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 79, 6)))
...
def _BuildAutomaton_6 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(ctModulationEntity._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Modulation')), pyxb.utils.utility.Location('/mnt/d/Repositories/data-translation/data/ceesim/schema/pattern/modulationEntityRootR1-0.xsd', 79, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
ctModulationEntity._Automaton = _BuildAutomaton_6()
