...
You will not be able to read the CEESIM format as you do not have a CEESIM system. __(I did not include these in the data dump - there are no CEESIM format files)__
